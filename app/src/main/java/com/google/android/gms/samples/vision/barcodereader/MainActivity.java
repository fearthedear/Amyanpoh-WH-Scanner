...
import com.google.android.gms.samples.vision.barcodereader.ui.camera.ApiCall;
        ...
        if (requestCode == RC_BARCODE_CAPTURE) {
            if (resultCode == CommonStatusCodes.SUCCESS) {
                if (data != null) {
                    ...
                    loadContent("https://login.amyanpoh.com/packages/find_by_token?token="+barcode.displayValue);
